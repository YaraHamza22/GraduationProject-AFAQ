...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "std.my_learning": "My Learning",
    "std.discover": "Discover Courses",
    "std.join_course": "Join Course",
    "std.enrolled_on": "Enrolled on",
    "std.progress_details": "Progress Details",
    ...
    "adm.admin": "Admin",
    "adm.logout": "Logout",
    "adm.secure_session": "Secure Session",
  ...
  ar: {
    ...
    "std.my_learning": "تعلمي",
    "std.discover": "اكتشاف الدورات",
    "std.join_course": "انضم للدورة",
    "std.enrolled_on": "تاريخ التسجيل",
    "std.progress_details": "تفاصيل التقدم",
