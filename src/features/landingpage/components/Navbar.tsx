...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className={`max-w-7xl mx-auto flex items-center justify-between rounded-2xl px-6 py-3 transition-all duration-500 ${scrolled
        ? "bg-slate-950/80 backdrop-blur-sm border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]"
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className={`text-2xl font-bold tracking-tight transition-colors duration-300 ${scrolled ? "text-white" : "text-white"
            }`}>
