  ...
  return (
    <div className='p-12 text-(--foreground) min-h-screen bg-(--background) transition-colors duration-300'>
      ...
      <div className="mt-12 max-w-2xl">
        <div className="p-8 rounded-[40px] bg-white dark:bg-white/5 border border-slate-300 dark:border-white/5 flex items-center gap-8 mb-8 shadow-sm dark:shadow-none">
